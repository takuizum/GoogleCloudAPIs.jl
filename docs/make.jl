...
for pkg in ("GoogleAuth", "GoogleApiCore", "GoogleCloudStorage", "GoogleBigQuery", "GoogleCloudPubSub")
...
makedocs(
    ...
    modules  = [GoogleAuth, GoogleApiCore, GoogleCloudStorage, GoogleBigQuery, GoogleCloudPubSub],
    checkdocs = :none,
